...
contract GameTreasuryV0 is DTAuth(1), IGameTreasury {
    ...
    function buybackTax(uint256 amount) external payable virtual override isActive returns (bool) {
    ...
    function migrateToNewVersion() external override isActive returns (bool) {
